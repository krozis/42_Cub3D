...
/*   Updated: 2023/01/25 15:04:58 by stelie           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
 ...
 * @param dirX: direction X of the player (which side the player is facing).
 * Can be 1, -1 or 0
 * @param dirY: direction Y of the player (which side the player is facing).
 * Can be 1, -1 or 0
 ...
 * @param cameraX: X-coordinate on the camera plane that the X-coordinate
 ...
 * @param sideDistX: distance between current position of the ray and
 * next X side of a case
 * @param sideDistY: distance between current position of the ray and
 * next Y side of a case
 * @param deltaDistX: distance between next X side of a case and the one after
 * (next X side + 1)
 * @param deltaDistY: distance between next Y side of a case and the one after
 * (next Y side + 1)
 ...
 * @param screen: the background image (ceiling+floor) + items drawn
